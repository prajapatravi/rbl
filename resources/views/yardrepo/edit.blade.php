    ...
    <div class="card">
        ...
        <div class="card-body card-block">
            ...
            {!! Form::model($yardrepo,
                      array(
                      'method' => 'PATCH',
                        'url' =>'yardrepo/'.Crypt::encrypt($yardrepo->id),
                        'class' => 'kt-form',
                    ...
                    <div class="col col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="text-input" name="name" placeholder="Yard Repo Name"
                                                                class="form-control" value="{{$yardrepo->name}}">
                        </div>
                    </div>
                    <div class="col col-md-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="branch_name" id="branch_name">
                                ...
                                @foreach ($branch as $item)
                                    <option value="{{$item->id}}" {{($yardrepo->branch_id==$item->id)?'selected':''}}>{{$item->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="text-input" name="location" placeholder="location"
                                                                class="form-control" value="{{$yardrepo->location}}">
                        </div>
                    </div>
     ...
     function getProduct(id){
        jQuery.ajax({
                    ...
                    success: function (res) {
                        ...
                        jQuery('#product').val('{{$yardrepo->product_id}}')
                    }
