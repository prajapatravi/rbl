									...
									<form>
										...
										<div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url(../../assets/media/misc/bg-1.jpg)">
											<h3 class="kt-head__title">
												Notifications
												&nbsp;
												<span class="btn btn-success btn-sm btn-bold btn-font-md">@{{logged_in_user_total_notifications}} new</span>
											</h3>
										...
										<div class="tab-content">
											<div class="tab-pane active show" id="topbar_notifications_notifications" role="tabpanel">
												<div class="kt-notification kt-margin-t-10 kt-margin-b-10 kt-scroll" data-scroll="true" data-height="300" data-mobile-height="200">
													...
													<div v-for="noti in logged_in_user_notifications">
													<a href="#" class="kt-notification__item" v-on:click="redirect_me_noti(noti.noti_id,noti.url)">
									...
									<form>
										...
										<div class="kt-head kt-head--skin-dark" style="background-image: url(../../assets/media/misc/bg-1.jpg)">
											<h3 class="kt-head__title">
												...
												<!-- <span class="btn btn-success btn-sm btn-bold btn-font-md">0 tasks pending</span> -->
											</h3>
										</div>
										...
										<div class="kt-grid-nav kt-grid-nav--skin-light">
											<div class="kt-grid-nav__row">
												...
												<a href="#" class="kt-grid-nav__item">
													...
													<span class="kt-grid-nav__title">A</span>
												</a>
												...
												<a href="#" class="kt-grid-nav__item">
													...
													<span class="kt-grid-nav__title">B</span>
												</a>
											</div>
											<div class="kt-grid-nav__row">
												<a href="{{url('business_settings')}}" class="kt-grid-nav__item">
													<span class="kt-grid-nav__icon">
														<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
															<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																<rect id="bound" x="0" y="0" width="24" height="24" />
													...
													<span class="kt-grid-nav__title">C</span>
												</a>
												<a href="#" class="kt-grid-nav__item">
													<span class="kt-grid-nav__icon">
														<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--success kt-svg-icon--lg">
													...
													<span class="kt-grid-nav__title">D</span>
												</a>
							...
							<div class="kt-header__topbar-item kt-header__topbar-item--user">
								<div class="kt-header__topbar-wrapper" data-toggle="dropdown" data-offset="0px,0px">
									<div class="kt-header__topbar-user">
										...
										<span class="kt-badge kt-badge--username kt-badge--unified-success kt-badge--lg kt-badge--rounded kt-badge--bold">
											@if(Auth::user()->avatar)
										<img src='{{Storage::url("company/_".Auth::user()->company_id."/user/_".Auth::Id()."/avatar/").Auth::user()->avatar}}' alt="Avatar">
										@else
										<img src="http://via.placeholder.com/70x70" alt="User Avatar" />
										@endif
										</span>
									</div>
								</div>
								<div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
									...
									<div class="kt-notification">
										...
										<a href="{{url('settings/subscription/plan')}}" class="kt-notification__item">
											<div class="kt-notification__item-icon">
												<i class="flaticon2-calendar-3 kt-font-success"></i>
											</div>
											<div class="kt-notification__item-details">
												...
												<div class="kt-notification__item-time">
													Subscription Plan settings and more
												</div>
											</div>
										</a>
										...
										<div class="kt-notification__custom">
											...
											<a class="btn btn-label-brand btn-sm btn-bold" href="{{ url('/logout') }}" 
