...
Route::group(['middleware' => ['auth']], function () {
 ...
 //   Route::get('user/{id}/disable','UserController@disable');  // for diable user
    Route::get('user/update-user-status/{id}/{status}', array('as' => 'User.status', 'uses' => 'UserController@changeStatus'));
    ...
    Route::get('/getBranches/{id}', 'BranchController@getBranches');
