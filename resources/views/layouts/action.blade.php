...
<div id="right-panel" class="right-panel" style="margin-left: 0px;">
    <!-- Header-->
    <header id="header" class="header" style="height: 66px;">
        <div class="top-left">
            ...
            <div class="header-menu">
                ...
                <div class="user-area dropdown float-right">
                    ...
                    <div class="user-menu dropdown-menu">
                        ...
                        style="">
                                    {{ csrf_field() }}
                            {{-- <input class="btn btn-sm info nav-link" type="submit" value="Logout"> --}}
                            <button class="btn btn-sm btn-link nav-link" type="submit"><i class="fa fa-power-off"></i>Logout</button>
                        </form>
                    </div>
                </div>
    ...
    <!-- /#header -->
    <div class="content" style="min-height:500px;bottom:0;background: whitesmoke;">
        @yield('content')
    </div>
</div>
...
{{-- <script src="{{URL::asset('public/assets/js/init/flot-chart-init.js')}}"></script> --}}
{{-- <!--  Chart js
