...
class BranchImport implements ToModel, WithHeadingRow,WithValidation,WithChunkReading
{
    ...
    */
    ...
    //    dd($row);
        ...
        $contant[]=['branch_id'=>$branch->id,'product_id'=>$product->id,'manager_id'=>$datauser['Collection_Manager']->id,'type'=>'Collection_Manager','bucket'=>$row['bucket'],'auditor_id'=> $auditor_id[0]];
        }
