...
<div class="kt-subheader__toolbar">
    ...
    <div class="kt-subheader__wrapper">
        ...
        <a href="<?php echo e(url('/qm_sheet/'.Crypt::encrypt($qm_sheet_data->id).'/list_parameter')); ?>"
                            ...
                            <div data-repeater-item class="form-group align-items-center">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <div class="kt-form__group--inline">
                                            ...
                                            <div class="kt-form__control">
                                                ...
                                                <input type="number" class="form-control" placeholder="Weightage"
                                                    name="weight">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <label class="kt-checkbox kt-checkbox--state-success">
                                            ...
                                            <input type="checkbox" name="s_pass" value="1"> Satisfactory
                                ...
                                <div class="col-md-2">
                                    ...
                                    <label class="kt-checkbox kt-checkbox--state-success">
                                        ...
                                        <input type="checkbox" name="s_fail" value="1"> Unsatisfactory
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\rbl\resources\views/qm_sheet/add_parameter.blade.php ENDPATH**/ ?>