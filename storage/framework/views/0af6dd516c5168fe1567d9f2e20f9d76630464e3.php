		...
		<div class="col-lg-12">
			<div class="card">
				<div class="card-header">
					...
					<a class="btn btn-primary btn-sm float-right" style="margin-right: 5px" href="<?php echo e(route('excelDownloadAllocation')); ?>" target="_blank">Export Allocation</a>
				</div>
				<div class="card-body">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\rbl\resources\views/allocation/list.blade.php ENDPATH**/ ?>