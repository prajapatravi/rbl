...
<div class="card" id="kt_repeater_1">
                    ...
                    <div data-repeater-item class="form-group align-items-center">
                        ...
                        <div class="row">
                            ...
                            <!-- <div class="col-md-3 form-group">
                                ...
                                <select name="branch_id" id="branchName" data-placeholder="Choose a Branch..."
                                    class="standardSelect form-control branchName" tabindex="2" required>
 ...
 -->
                            ...
                            <!-- <div class="col-md-3 form-group">
                                ...
                                <input type="number" id="branch_repo" name="branch_repo"
                                    class="form-control branch_repo" placeholder="Enter Total Branch Repo">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="number" id="agencies" name="agencies" class="form-control agencies"
...
<!-- 
                            <div class="col-md-3 form-group">
                                ...
                                <input type="number" id="agency_repo" name="agency_repo"
                                    class="form-control agency_repo" placeholder="Enter Total Agency Repo">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="number" id="yard" name="yard" class="form-control yard"
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="number" id="yard_repo" name="yard_repo" class="form-control yard_repo"
                                    placeholder="Enter Total Yard Repo">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <input type="number" id="collection_manager" name="collection_manager"
                                    class="form-control collection_manager" placeholder="Enter Total CM" required>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\rbl\resources\views/beat_plan/create.blade.php ENDPATH**/ ?>