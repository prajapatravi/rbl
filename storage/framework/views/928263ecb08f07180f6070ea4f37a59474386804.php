            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-primary btn-sm float-right" style="margin-right: 5px"
                        href="<?php echo e(route('excelDownloadAgency')); ?>" target="_blank">Export Agency</a>
                    <a class="btn btn-info btn-sm float-right" style="margin-right: 5px"
                        href="<?php echo e(route('agencyExcelUpload')); ?>" target="_blank">Import Agency</a>
                </div>
                <div class="card-body">
                    <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                        ...
                        <tbody>
                            ...
                            <tr scope="row">
                                ...
                                <!-- <td><?php echo e(isset($row->branch)?$row->branch->name:''); ?></td> -->
                                <td><?php echo e($row->agency_id ?? ''); ?></td>
                                <td><?php echo e($row->user->nam ?? ''); ?></td>
                                ...
                                <td nowrap>
                                    ...
                                    <a href="<?php echo e(url('agency/'.Crypt::encrypt($row->id).'/edit')); ?>"
                                        class="btn btn-xs btn-info" title="View">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a href="<?php echo e(url('agency/'.Crypt::encrypt($row->id))); ?>" class="btn btn-xs btn-danger"
                                        title="View">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\rbl\resources\views/agency/list.blade.php ENDPATH**/ ?>