		...
		<div class="col-lg-12">
			...
			<div class="card">
				...
				<div class="card-header">
					...
					<a class="btn btn-primary btn-sm float-right" style="margin-right: 5px" href="<?php echo e(route('product.create')); ?>">Create Product</a>
				</div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\rbl\resources\views/product/list.blade.php ENDPATH**/ ?>