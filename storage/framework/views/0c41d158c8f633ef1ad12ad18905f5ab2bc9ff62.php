				...
				<tr>
					<td valign="top" class="bg_white" style="padding: 1em 2.5em 0 2.5em;">
						...
						<div class="text" style="padding: 2em 0.5em; text-align: left;">
							...
							<strong style="font-family: 'Calibri', sans-serif; color:red; font-size:14px;">Hi <?php echo e($audit->collectionManagerData->name); ?>,</strong>
							<br/>
							<br/>
							<div>
								<div class="text" style="padding: 0.5em; text-align: left;">
									<strong
										style="font-family: 'Calibri', sans-serif;color:red; font-size:14px;"><ins>Greetings from QDegrees ! </ins></strong>
								</div>
							...
							<div>
								...
								<div class="text" style="padding: 0.5em; text-align: left;">
									<strong style="font-family: 'Calibri', sans-serif; font-size: 14px;"><ins>
								...
								<br>
								<?php if($audit->qmsheet->type == 'agency'): ?>
								<div class="text" style="padding: 0.5em; text-align: left;">
									<strong style="font-family: 'Calibri', sans-serif; font-size: 14px;"><ins>
								...
								<table style="width:100%; font-family:'Calibri', sans-serif, monospace; font-size:14px">
									...
									<tr>
									    <td><?php echo e($audit->agency->location); ?></td>
									    <td><?php echo e($nameAudit); ?></td>
									    <td><?php echo e($audit->agency->agency_id); ?></td>
									    <td></td>
									    <td></td>
								        <td><?php echo e($audit->collectionManagerData->name); ?></td>
								        <td><?php echo e($audit->productnew->name); ?></td>
								...
								<div>
									<div class="text" style="padding: 0.5em; text-align: left;">
										<strong
											style="font-family: 'Calibri', sans-serif; color:red; font-size: 14px;"><ins>Note:-</ins></strong>
									</div>
