...
<aside id="left-panel" class="left-panel">
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav"  style="background: #2f353a;">
                    <?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', 'Collection Manager')): ?>
                    <li>
		...
		<li class="menu-item-has-children dropdown">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                         
                            ...
                            <li><i class="fa fa-plus"></i><a href="<?php echo e(route('userhierarchy.create')); ?>">Create User Hierarchy</a></li>
                            <li><i class="fa fa-users"></i><a href="<?php echo e(route('userhierarchy.index')); ?>">User Hierarchy List</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="fa fa-plus"></i><a href="<?php echo e(route('productattribute.create')); ?>">Create Sub Product</a></li>
                            <li><i class="fa fa-users"></i><a href="<?php echo e(route('productattribute.index')); ?>">Sub Product List</a></li>
                    ...
                    <?php endif; ?>
                    <?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', 'Admin|Quality Auditor')): ?>
                    <li class="menu-item-has-children dropdown">
                    ...
                    <?php endif; ?>
                    <?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', 'Admin|Quality Control')): ?>
                    <li class="menu-item-has-children dropdown">
                    ...
                    <?php endif; ?>
                    <?php if (\Illuminate\Support\Facades\Blade::check('hasanyrole', 'Quality Auditor')): ?>
                    <li class="menu-item-has-children dropdown">
    ...
    <!-- /#left-panel --><?php /**PATH C:\wamp64\www\rbl\resources\views/layouts/sidebar.blade.php ENDPATH**/ ?>