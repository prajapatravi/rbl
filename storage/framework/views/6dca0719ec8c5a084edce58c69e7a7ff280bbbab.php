        ...
        <div class="card">
            ...
            <div class="card-body card-block">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="location" name="location" placeholder="Location" class="form-control"
                                value="<?php echo e(old('location', $data->location)); ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="mobile_number" name="mobile_number" placeholder="Mobile Number"
                                class="form-control" value="<?php echo e(old('mobile_number', $data->mobile_number)); ?>">
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="branch_name" data-placeholder="Choose a Branch..." class="standardSelect form-control" tabindex="1">
                                ...
                                <?php $__currentLoopData = $branch; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($item->id); ?>" <?php echo e(($data->branch_id == $item->id) ? 'selected' : ''); ?>><?php echo e($item->name); ?></option>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="agency_id" name="agency_id" placeholder="Agency ID"
                                class="form-control" value="<?php echo e($data->agency_id); ?>">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="agency_manager" data-placeholder="Choose an Agency Manager..."
                                ...
                                <option value="<?php echo e($item->id); ?>" <?php echo e(($data->agency_manager == $item->id) ? 'selected' : ''); ?>>
                    ...
                    <div class=" form-group">
                        <label for="location" class=" form-control-label">Location</label>
                        <input type="text" id="location" name="location" placeholder="Location" class="form-control" value="<?php echo e($data->location); ?>">
                    </div>
                </div>
                    <div class="col-md-6">
                        <div class="form-group">
...
<script>
    jQuery(document).ready(function () {
        var stateId = <?php echo e($data->city->state->id ?? ''); ?>;
        var cityId = <?php echo e($data->city->id ?? ''); ?>;
        ...
        jQuery('#country').change(function () {
            ...
            if (countryId) {
                jQuery.ajax({
                    type: "GET",
                    url: "<?php echo e(url('/getStates')); ?>/" + countryId,
        ...
        jQuery('#state').change(function () {
            ...
            if (stateId) {
                jQuery.ajax({
                    type: "GET",
                    url: "<?php echo e(url('/getCities')); ?>/" + stateId,
                    success: function (res) {
                        if (res) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\rbl\resources\views/agency/edit.blade.php ENDPATH**/ ?>